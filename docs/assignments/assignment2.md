...
- List of 21 Features:
    ...
    - Feed filters- be able to change to only see friends and faily - Users can customize their feed to prioritize posts from specific people (like close family or friends) or filter out less relevant content, ensuring they stay connected with the most important updates.
    ...
    - Family and Friends Location Sharing: A "conset-given" feature allowing users to share their real-time location with trusted contacts. This can help in cases where users are lost or need guidance to a specific place.
...
- List of 6 VSD analysis
    ...
    4. Time: Long-Term Health and Well-Being 
        ...
        - Design Response: Introduceing a "well-being" tracker to promote physical and social activity. This will encourage users to engage with the world outside of their phone and plan physical meet-ups with friends and family.
